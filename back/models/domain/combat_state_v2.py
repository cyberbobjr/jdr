"""
Pydantic Model for Combat State (v2)
Manages the real-time state of a combat encounter.
"""
...
# Assuming CharacterV2 and NPCV2 are available in the same models directory
from .character_v2 import CharacterV2
from .npc_v2 import NPCV2
...
class Combatant(BaseModel):
    ...
    # Current combat stats (can be a subset or reference to CharacterV2/NPCV2 combat_stats)
    ...
    character_ref: Optional[CharacterV2] = Field(default=None, description="Full CharacterV2 data if player")
    npc_ref: Optional[NPCV2] = Field(default=None, description="Full NPCV2 data if NPC")
